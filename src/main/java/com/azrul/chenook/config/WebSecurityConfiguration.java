...
import com.azrul.chenook.security.JwtAuthConverter;
import com.azrul.chenook.security.JwtAuthForAPIConverter;
import com.azrul.chenook.security.KeycloakLogoutHandler;
    ...
    public GrantedAuthoritiesMapper userAuthoritiesMapper() {
        return (authorities) -> {
            ...
            authorities.forEach(authority -> {
                ...
                if (OidcUserAuthority.class
                        .isInstance(authority)) {
                    OidcUserAuthority oidcUserAuthority = (OidcUserAuthority) authority;
                    OidcIdToken idToken = oidcUserAuthority.getIdToken();
                    OidcUserInfo userInfo = oidcUserAuthority.getUserInfo();
                } else if (OAuth2UserAuthority.class
                        .isInstance(authority)) {
